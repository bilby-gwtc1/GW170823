...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['lalinference-reweighted'] = ['a_1', 'a_2', 'luminosity_distance', 'ra', 'dec', 'mass_1', 'mass_2', 'tilt_1', 'tilt_2', 'chirp_mass', 'total_mass', 'symmetric_mass_ratio', 'mass_ratio', 'log_likelihood', 'redshift', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source'];
    list['bilby'] = ['chirp_mass', 'mass_ratio', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'dec', 'ra', 'psi', 'geocent_time', 'luminosity_distance', 'phase', 'log_likelihood', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'iota', 'chi_eff', 'chi_p', 'redshift', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source'];
    ...
    var data = {}
    data['lalinference-reweighted'] = {'width': 200.0, 'height': 200.0, 'seperation': 10.000000000000028, 'x0': 100.00000000000003, 'y0': 100.00000000000003};
